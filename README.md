...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-usethis-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-usethis-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-usethis-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-usethis-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-usethis-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-usethis-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-usethis` can be installed with:

```
conda install r-usethis
```

It is possible to list all of the versions of `r-usethis` available on your platform with:
